...
public class MonitorMethodVisitor extends MethodVisitor {
    ...
    // 不要修改
    private static final String OWNER = "com/hyperion/methodmonitor/business/MethodTimeManager";
    private static final String METHOD_GETINSTANCE = "getInstance";
    private static final String DESC_GETINSTANCE = "()Lcom/hyperion/methodmonitor/business/MethodTimeManager;";
